...
public class NetworkUtils {
    ...
    public static final File IMAGE_FOLDER_FILE = new File(InsiderLouisevilleApp.Instance().getCacheDir(), "images/");
    ...
    public static synchronized void deleteFeedImagesCache(Uri entriesUri, String selection) {
        if (IMAGE_FOLDER_FILE.exists()) {
            ...
            Cursor cursor = InsiderLouisevilleApp.Instance().getContentResolver().query(entriesUri, FeedData.EntryColumns.PROJECTION_ID, selection, null, null);
    ...
    public static boolean needDownloadPictures() {
        ...
        if (PrefUtils.getBoolean(PrefUtils.DISPLAY_IMAGES, true)) {
            if (Constants.FETCH_PICTURE_MODE_ALWAYS_PRELOAD.equals(fetchPictureMode)) {
                ...
                ConnectivityManager cm = (ConnectivityManager) InsiderLouisevilleApp.instance().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static HttpURLConnection setupConnection(URL url) throws IOException {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) InsiderLouisevilleApp.Instance()
