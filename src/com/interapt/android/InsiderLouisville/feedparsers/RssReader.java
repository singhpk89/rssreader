...
public class RssReader {
	 ...
	 */
	public static ArrayList<News> getLatestRssFeed(){
		String feed = "http://insiderlouisville.com/feed/?xml";
		
		
		RSSHandler rh = new RSSHandler();
		ArrayList<News> articles =  rh.getLatestArticles(feed);
	 ...
	 * @return List<JSONObject> - suitable for the List View activity
	 */
	private static ArrayList<News> fillData(ArrayList<News> articles) {

		ArrayList<JSONObject> items = new ArrayList<JSONObject>();
        for (News article : articles) {
            JSONObject current = new JSONObject();
            try {
            	article.setJsonObject(buildJsonObject(article, current));
	 ...
	 */
	private static JSONObject buildJsonObject(News article, JSONObject current) throws JSONException {
